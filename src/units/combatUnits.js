const combatUnits = [
  ...
  },
  {
    type: 'group', name: 'Lannister', items: [
      { name: "Gregor Clegane", KS: true, cost: 4, attachment: "None", type: "Solo", unique: true, imgFile: "./Images/Lannister/CombatUnit-Cards/LAN-CombatUnit-Gregor-Mounted.png" },
  ...
  },
  {
    type: 'group', name: 'FreeFolk', items: [
      ...
      { name: "Savage Giant", cost: 7, attachment: "None", type: "Solo", unique: false, imgFile: "./Images/FreeFolk/CombatUnit-Cards/FF-CombatUnit-Giant.png" },
  ...
  },
  {
    type: 'group', name: 'Baratheon', items: [
      { name: "Baratheon Wardens", cost: 5, attachment: "None", type: "Infantry", unique: false, imgFile: "" },
      { name: "Baratheon Sentinels", cost: 6, attachment: "None", type: "Infantry", unique: false, imgFile: "" },
      { name: "Rose Knights", Loyalty: "Renly Baratheon", cost: 7, attachment: "None", type: "Infantry", unique: false, imgFile: "" },
      { name: "R'hllor Faithful", Loyalty: "Stannis Baratheon", cost: 7, attachment: "None", type: "Infantry", unique: false, imgFile: "" },
      { name: "Stag Knights", cost: 8, attachment: "None", type: "Infantry", unique: false, imgFile: "" },
    ]
  },
  {
    type: 'group', name: 'Targaryen', items: [
      { name: "Jorah Mormont", cost: 3, attachment: "None", type: "Solo", unique: true, imgFile: "" },
      { name: "Dothraki Outriders", cost: 6, attachment: "None", type: "Cavalry", unique: false, imgFile: "" },
      { name: "Dothraki Screamers", cost: 6, attachment: "None", type: "Cavalry", unique: false, imgFile: "" },
      { name: "Unsullied Swordmasters", cost: 9, attachment: "None", type: "Infantry", unique: false, imgFile: "" }, 
      { name: "Dothraki Veterans", cost: 10, attachment: "None", type: "Cavalry", unique: false, imgFile: "" },
    ]
  },
]
